...
#endif
	kprintf(L"\n"
		L"wwwwwww" MIMIKATZ_FULL L"\n"
		L"wwwwwww" MIMIKATZ_SECOND L" - (oe.eo)\n"
		L"wwwwwww /*** Benjamin DELPY `gentilkiwi` ( benjamin@gentilkiwi.com )\n"
		L"wwwwwww      > https://blog.gentilkiwi.com/mimikatz\n"
		L"wwwwwww     Vincent LE TOUX             ( vincent.letoux@gmail.com )\n"
		L"wwwwwww     > https://pingcastle.com / https://mysmartlogon.com ***/\n");
